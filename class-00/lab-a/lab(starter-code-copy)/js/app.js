...
function displayPics(){
  ...
  // This threw an error because rando is defined locally inside the code block of the while loop of the displayPics function and we are trying to access it (console.log it) outside the scope of the while loop
  console.log(viewed);
